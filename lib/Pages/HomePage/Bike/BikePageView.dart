...
import 'package:ride_sharing/Pages/HomePage/Bike/searchDestinationPoint.dart';
...
//
//
//   // LocationData currentLocation=LatLng(0.00, 0.00) as LocationData;
//   //
...
//   //   PolylinePoints polylinePoints=PolylinePoints();
//   //   PolylineResult result=await polylinePoints.getRouteBetweenCoordinates("AIzaSyBsPxSFf2or6oZnbq7urgrxlakTiVqTmjQ",
//   //       PointLatLng(BikePageView.SourceLocation.latitude, BikePageView.SourceLocation.longitude),
//   //     PointLatLng(BikePageView.DestinationLocation.latitude, BikePageView.DestinationLocation.longitude),
//   //   );
//   //   if(result.points.isNotEmpty){
