...
class SetOnMapForBike extends StatefulWidget {
  const SetOnMapForBike({Key? key}) : super(key: key);

  @override
  State<SetOnMapForBike> createState() => _SetOnMapForBikeState();
}

class _SetOnMapForBikeState extends State<SetOnMapForBike> {
